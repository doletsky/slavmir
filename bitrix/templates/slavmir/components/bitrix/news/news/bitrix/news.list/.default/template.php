...
<?}?>
	<?foreach( $arResult["ITEMS"] as $arItem ){
        ...
        <div class="news_page_item">
            ...
            ?>
            <a href="<?=$arItem["DETAIL_PAGE_URL"]?>"<?if($arResult["cMon"]!=1 && $arItem["PROPERTIES"]["IS_NO_AUTH"]["VALUE_XML_ID"]!="Y" ){?> class="subs"<?}?>><span class="news_img" style="background-image: url(<?=$image?>);"></span></a>
            <div class="news_text">
                <div class="news_head">
