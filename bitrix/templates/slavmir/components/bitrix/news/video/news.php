...
<?$GLOBALS["videoFilter"]=array("PROPERTY_CATEGORY"=>40);// Видео дня?>
<?$APPLICATION->IncludeComponent("bitrix:news.list", "video-slider", Array(
	"COMPONENT_TEMPLATE" => ".default",
		"IBLOCK_TYPE" => "catalog",	// Тип информационного блока (используется только для проверки)
		"IBLOCK_ID" => "3",	// Код информационного блока
		"NEWS_COUNT" => "4",	// Количество новостей на странице
		"SORT_BY1" => "PROPERTY_DT",	// Поле для первой сортировки новостей
