...
function playVideoFile(file){
	...
	*/
	if( isMobile ){
		$("#"+VIDEO_PLAYER_ID).html('<iframe width="100%" height="100%" src="https://www.youtube.com/embed/'+file+'?rel=0" frameborder="1" allowfullscreen></iframe>');
	}
	else{
...
/*  =================================================================================================== */
function setPlayerPicture( path ){
