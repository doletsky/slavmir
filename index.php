...
if($_REQUEST["PLAYER_AJAX"]=="Y"){
    ...
    $APPLICATION->SetPageProperty("description", "Портал «Славянский Мир» - ежедневно слушать онлайн радио эфиры на официальном сайте. Радио, Видео, Статьи о славянском народе.");
    $APPLICATION->SetPageProperty("title", "Портал «Славянский Мир» - официальный сайт ");
...
<!-- index_content --><? if($_REQUEST["PLAYER_AJAX"]!="Y")require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php"); ?>