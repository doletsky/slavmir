<?
    ...
    $fDataJson='{"sno": "usn_income","items":[{"name": "Доступ к контенту","quantity": 1,"sum":'.$params['PAYMENT_SHOULD_PAY'].',"tax": "none"}]}';
?>
<form action="<?=$params['URL']?>" method="post" target="_blank">
	<font class="tablebodytext">
        ...
        <input type="hidden" name="Receipt" value="<?=urlencode($fDataJson)?>">
