...
class RoboxchangeHandler extends PaySystem\ServiceHandler
{
	...
	public function initiatePay(Payment $payment, Request $request = null)
	{
        ...
        $fisData='{"sno": "usn_income","items":[{"name": "Доступ к контенту","quantity": 1,"sum":'.$paymentShouldPay.',"tax": "none"}]}';
    $signatureValue = md5(
        ...
        file_put_contents($_SERVER['DOCUMENT_ROOT']."/personal/log2.txt", $fisData);
