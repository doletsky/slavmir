...
if($_REQUEST["PLAYER_AJAX"]=="Y"||$_REQUEST['formresult']=='addok'){
    ?><script>
        var pageTitle='Контактная информация';
        var headerBg="/upload/medialibrary/c40/c40c35d400fbc6f27f0ecab415a8503a.jpg";
    </script><?
}else{
		...
		<div class="left_col">
			...
			<div class="write_us">
				...
				<?$APPLICATION->IncludeComponent("bitrix:form", "contacts", Array(
						...
						"SUCCESS_URL" => "/kontakty/",	// Страница с сообщением об успешной отправке
...
<?if($_REQUEST["PLAYER_AJAX"]!="Y" && $_REQUEST['formresult']!='addok')require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>