...
elseif (ForumCurrUserPermissions(1) <= "E")
{
    $arError[] = array(
        "code" => "access denied",
...
//$strErrorMessage='';
//$strOKMessage='';
//echo $fmid=ForumAddMessage(
//    $MESSAGE_TYPE,
//1,
//    $FORUM_TOPIC_ID,
// 0,
// array (
//     "POST_MESSAGE" => $_REQUEST['REVIEW_TEXT'],
//     "TITLE" => "",
//     "AUTHOR_NAME" => $aName,
// ),
//     $strErrorMessage,
//    $strOKMessage
//);
//echo $strErrorMessage."<br>".$strOKMessage;
//if($FORUM_TOPIC_ID == 0){
//    $arMessage = CForumMessage::GetByID($fmid);
//    echo $FORUM_TOPIC_ID = IntVal($arMessage["TOPIC_ID"]);
//    CIBlockElement::SetPropertyValueCode($ELEMENT_ID, "FORUM_TOPIC_ID", $FORUM_TOPIC_ID);
//}
