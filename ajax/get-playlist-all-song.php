...
$playlistIDs = $_REQUEST["ids"];
if( is_array($playlistIDs )) throw new Exception("Ошибка входных параметров", 1);
...
$audios=array();
$artistIDs=array();
$arFilter = Array( "IBLOCK_ID"=>AUDIO_IBLOCK_ID, 'ACTIVE'=>'Y', "ID"=>$playlistIDs );
...
//echo json_encode( $APPLICATION->GetPageProperty("JSON") );
?>